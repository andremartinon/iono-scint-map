...
[![Python: 3.12+](https://img.shields.io/badge/Python-3.12_|_3.13_|_3.14-red.svg?style=flat-square&logo=python&logoColor=white)](https://www.python.org/)
[![Linux kernel: 6.x](https://img.shields.io/badge/Linux-kernel_6.x_|_7.x-cyan.svg?style=flat-square&logo=linux&logoColor=white)](https://www.linuxfoundation.org/)
...
* **Licensing:** In accordance with platform terms and regional copyright
  guidelines, the raw AI-generated banner asset is free to use and carries no
